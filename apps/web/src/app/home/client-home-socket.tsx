...
import type { User, Post as PostWithUser } from "@prisma/client";
...
function ClientHomeSocket({ channel }: ClientPostSocketProps) {
  ...
  useEffect(() => {
    ...
    const onOpen = () => {
      console.log("WebSocket Home Connection opened");
    ...
    const onError = (event: Event) => {
      console.error("WebSocket Home Error:", event);
    };

    const onClose = () => {
      console.log("WebSocket Home closed");
    };
...
export default ClientHomeSocket;
